                  ...
                  <div className="absolute inset-0 flex items-center justify-center p-8">
                    <div className="text-center text-white">
                      ...
                      <p className="text-lg opacity-90 max-w-md mx-auto leading-relaxed">
                        Sign in to unlock your premium e-books and reading
                        tools.
                      </p>
                    </div>
                  </div>
                ...
                <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center bg-slate-300 bg-opacity-90">
                  ...
                  <div className="text-center lg:text-left mb-6">
                    ...
                    <p className="text-indigo-700 text-sm">
                      Access your premium Luxora dashboard
                    </p>
                  </div>
                  ...
                  <form onSubmit={formik.handleSubmit} className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <label className="text-indigo-700 text-opacity-80 text-xs">
                          Remember me
                        </label>
                      </div>
                      <a
                        href="#"
                        className="text-purple-700 text-xs underline hover:text-purple-900 transition-colors duration-200">
                        Forgot password?
                      </a>
                    </div>
